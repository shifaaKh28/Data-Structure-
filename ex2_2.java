...
public class Ex2_2 {
    public static void mergeSort3Way(Integer[] arr) {
        ...
        Integer[] fArray = new Integer[arr.length];
        ...
        // sort function
        mergeSort3WayRec(fArray, 0, arr.length, arr);
    ...
    public static void mergeSort3WayRec(Integer[] arr, int low, int high, Integer[] destArray) {
        ...
        mergeSort3WayRec(destArray, low, mid1, arr);
        mergeSort3WayRec(destArray, mid1, mid2, arr);
        mergeSort3WayRec(destArray, mid2, high, arr);
    ...
    public static void main(String[] args) {
        ...
        Integer[] data2={-10,-60,-10,-4,8,7,9,3,4,55,55,-10,22};
        mergeSort3Way(data);
        mergeSort3Way(data2);
